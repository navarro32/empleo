<template>
  <div>
    ...
    <v-app-bar app>
      ...
      <v-toolbar-title>
        <router-link to="/">{{ datosP.nombres }} {{ datosP.apellidos }}</router-link>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      <v-avatar>
        <img :src="$store.state.avatar" v-if="$store.state.avatar!=''" />
        <img :src="datosP.logo" :alt="datosP.razon_social" v-else-if="datosP.logo" />
        <img v-else src="../usuarios/img/default.jpg" />
      </v-avatar>
          ...
          <v-list>
            <v-list-item>
              ...
              <v-list-item-content>
                ...
                <v-list-item-subtitle>{{ datosP.email }}</v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item>
          </v-list>
