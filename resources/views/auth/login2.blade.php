                    ...
                    <form method="POST" action="{{ route('recibelogin') }}">
                        ...
                        <div class="form-group row">
                            <div class="input-group col-md-12">
                                ...
                                <input id="password" type="password" value="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Ingresa tu contraseña">
                                @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row offset-1 ">
                            ...
                            <a name="" id="" class="btn btn-primary col-5" href="{{ route('register2')}}" role="button">Registrarse</a>
